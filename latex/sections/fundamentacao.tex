...
A Transformada de Fourier de Curta Duração (STFT, do inglês \textit{Short-Time Fourier Transform}) baseia-se nesse princípio. O sinal é dividido em segmentos de curta duração, denominados quadros (\textit{frames}), e uma transformada é aplicada individualmente a cada um deles.
