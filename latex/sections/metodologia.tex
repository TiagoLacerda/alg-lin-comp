...
O algoritmo desenvolvido neste trabalho foi implementado em C++17 utilizando o framework JUCE \cite{juce}, na forma de um plugin VST 3 (\textit{Virtual Studio Technology 3}) compatível com diferentes DAWs (do inglês, \textit{Digital Audio Workstation}).
